...
const Travle = ({ imgSrc, travle_Price, travle_head,Badge_text,className }) => {
    return (
        <div className={`${className}`}>
            <div className='w-[512px] pb-[32px] pt-[16px] px-[16px]  travel relative'>
                ...
                <Badge text={Badge_text} className="absolute top-[32px] left-[418px]"/>

                <Flex className={`items-center justify-between`}>
                    <div className="">
                        <Travle_Head text={travle_head} />
                        <Common_TxT_Three text="Hiking Tour | Stoke on Trent" className={`mt-[8px] mb-[28px]`} />
                    </div>
                ...
                <Flex className={`items-center justify-between`}>
                    <div>
                        <Common_txt_Two text={`from`} className={"text-[14px]"} />
